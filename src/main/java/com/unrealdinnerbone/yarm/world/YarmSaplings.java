...
public class YarmSaplings extends BlockSapling
{
    public static final String[] saplings = new String[] {"Blue Tree"};
    private static final IIcon[] icon = new IIcon[saplings.length];

    protected YarmSaplings()
    {
        float f = 0.4F;
...
/**
    ...
    {
        p_149691_2_ &= 7;
        return icon[MathHelper.clamp_int(p_149691_2_, 0, 5)];
    }
...
/**
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        {
            icon[i] = p_149651_1_.registerIcon(this.getTextureName() + "_" + saplings[i]);
        }
    }
