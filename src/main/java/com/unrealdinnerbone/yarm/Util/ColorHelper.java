...
public enum ColorHelper
{
    ...
    public static final ColorHelper[] VALID_COLORS = {BLACK, DBLUE, DGREEN, DAQUA, DRED, DPURPLE, GOLD, GRAY, DGRAY, BLUE, GREEN, AQUA, RED, LPURPLE, YELLOW, WHITE};
    private static final String MCStyle  = "\u00A7";
    private final String color;

    ColorHelper(String num){
        this.color = MCStyle + num;
    }

    public static ColorHelper getRandom(){
