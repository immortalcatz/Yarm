package com.unrealdinnerbone.yarm.compact.WAILA;
...
public class WailaCompatibility implements IWailaDataProvider {
    ...
    public static void load(IWailaRegistrar registrar) {
        ...
        if (!loaded) {
            registrar.registerHeadProvider(INSTANCE, BlockNightPanelTeir1.class);
            registrar.registerBodyProvider(INSTANCE, BlockNightPanelTeir1.class);
            registrar.registerTailProvider(INSTANCE, BlockNightPanelTeir1.class);
            loaded = true;
        }
    }
    ...
    public static void register(){
        if (registered)
            return;
        registered = true;
        FMLInterModComms.sendMessage("Waila", "register", "com.unrealdinnerbone.yarm.compact.WAILA.WailaCompatibility.load");
    }
